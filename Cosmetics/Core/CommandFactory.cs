...
namespace Cosmetics.Core
{
    public class CommandFactory : ICommandFactory
    {
        ...
        public ICommand Create(string commandLine)
        {
            ...
            Enum.TryParse(command, true, out CommandType result);
            ...
            switch (result)
            {
                ...
                default:
                    throw new ArgumentException($"Invalid command name: {command}!");
            }
        }
        ...
        //    throw new ArgumentException($"Invalid command name: {value}!");
        //}
